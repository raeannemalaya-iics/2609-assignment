 function validate() {
    ...
    if( document.myForm.title.value == "" ) {
        alert( "Please please put an input in the Event Title");
        document.myForm.title.focus() ;
        return false;
     }

     if( document.myForm.date1.value == "" ) {
        alert( "Please please put an input in the Event Dates");
     ...
     if( document.myForm.postdate.value == "" ) {
        alert( "Please please put an input in the Posting Date");
